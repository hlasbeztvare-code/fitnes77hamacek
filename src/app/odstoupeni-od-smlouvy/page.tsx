  ...
  const onSubmit = async (data: WithdrawalForm) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        console.error('L-CODE SECURITY ALERT:', errorData.error);
        setStatus('error');
      }
    } catch (err) {
      setStatus('error');
      ...
      <div className="min-h-screen bg-black flex items-center justify-center p-6">
        ...
        >
          ...
          <div className="flex flex-col gap-4 pt-6">
            ...
            <button onClick={() => window.location.href = '/'} className="w-full bg-zinc-900 text-white px-10 py-5 font-black uppercase tracking-widest hover:bg-zinc-800 transition-all">
    ...
    <div className="min-h-screen bg-white text-black py-32 px-6 relative overflow-hidden">
      <div className="max-w-2xl mx-auto relative z-10">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          {/* L-CODE SECURITY: Honeypot */}
          <div className="hidden" aria-hidden="true">
            <input 
              type="text" 
              {...register('_full_name_confirm_')} 
              tabIndex={-1} 
              autoComplete="off" 
            />
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-2">
              ...
              <input 
                id="orderId" {...register('orderId')} placeholder="2026XXXX"
            ...
            <div className="space-y-2">
              ...
              <input 
                id="date" {...register('date')} type="date"
          ...
          <div className="space-y-2">
            ...
            <input 
              id="name" {...register('name')} placeholder="JAN NOVÁK"
          ...
          <div className="space-y-2">
            ...
            <input 
              id="email" {...register('email')} type="email" placeholder="EMAIL@SERVER.CZ"
          ...
          <div className="space-y-2">
            ...
            <textarea 
              id="reason" {...register('reason')} rows={4} placeholder="STRUČNĚ POPIŠTE STAV ZBOŽÍ..."
          ...
          <div className="pt-6">
            <label className="flex gap-4 cursor-pointer group items-start">
              <div className="relative flex items-center justify-center mt-1">
                <input {...register('confirmation')} type="checkbox" className="peer appearance-none w-6 h-6 border-2 border-zinc-200 checked:bg-[#E10600] checked:border-[#E10600] transition-all cursor-pointer" />
          ...
          {status === 'error' && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex items-center gap-4 p-6 bg-red-50 border border-red-100 text-red-600 text-[10px] font-black uppercase tracking-widest">
...
// clean code comment: Goliáš Legislative Bridge | Hardened Security v1.1. smrk
