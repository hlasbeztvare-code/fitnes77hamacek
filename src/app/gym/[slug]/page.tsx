    ...
    <div className="min-h-screen bg-[#050505] text-white">
      ...
      <div className="relative h-screen flex items-end overflow-hidden">
        ...
        <div className="relative z-10 px-6 md:px-16 pb-20 max-w-4xl">
          ...
          <h1 className="text-[13vw] md:text-[8vw] font-black uppercase leading-[0.85] tracking-tighter font-bebas">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
          ...
          <div>
            ...
            {(phone || instagram || email) && (
              <div className="mt-16 space-y-4">
                ...
                {phone && (
                  <a href={`tel:${phone.replace(/\s/g, '')}`} className="flex items-center gap-4 text-4xl font-black font-bebas tracking-widest text-white hover:text-[#d4ff00] transition-colors duration-300 group">
                    <span className="w-3 h-3 rounded-full bg-[#d4ff00] group-hover:scale-150 transition-transform duration-300" />
                    {phone}
                  </a>
                )}
                {instagram && (
                  <a href={instagram} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-2xl font-black font-bebas tracking-widest text-white hover:text-[#d4ff00] transition-colors duration-300 group">
                    <span className="w-3 h-3 rounded-full bg-[#d4ff00] group-hover:scale-150 transition-transform duration-300" />
                    @beatacejnarova
                  </a>
                )}
          ...
          <div className="space-y-8">
            <div className="border border-[#d4ff00]/20 p-10 bg-white/[0.02]">
              ...
              {phone ? (
                <a href={`tel:${phone.replace(/\s/g, '')}`} className="inline-block w-full text-center bg-[#d4ff00] text-black font-black uppercase tracking-[0.2em] px-8 py-5 font-bebas text-2xl hover:bg-white transition-colors duration-300">
                  Zavolat trenérovi
                </a>
              ) : instagram ? (
                <a href={instagram} target="_blank" rel="noopener noreferrer" className="inline-block w-full text-center bg-[#d4ff00] text-black font-black uppercase tracking-[0.2em] px-8 py-5 font-bebas text-2xl hover:bg-white transition-colors duration-300">
                  Napsat na Instagram
                </a>
              ) : (
                <a href={`mailto:${email ?? 'fitness77@post.cz'}`} className="inline-block w-full text-center bg-[#d4ff00] text-black font-black uppercase tracking-[0.2em] px-8 py-5 font-bebas text-2xl hover:bg-white transition-colors duration-300">
            ...
            <div className="border border-white/5 p-8 space-y-4">
              ...
              <p className="text-3xl font-black font-bebas tracking-widest text-white">FITNESS 77 MLADÁ BOLESLAV</p>
      ...
      {profile?.focus && (
        <div className="px-6 md:px-16 pb-32 max-w-[1400px] mx-auto">
          <div className="border-t border-white/5 pt-24 mb-16">
            ...
            <h2 className="text-[8vw] md:text-[4vw] font-black uppercase leading-[0.85] tracking-tighter font-bebas">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {profile.focus.map((item, i) => (
              <div key={i} className="border border-white/5 p-8 hover:border-[#d4ff00]/30 transition-colors duration-500 group">
                ...
                <h3 className="text-2xl font-black uppercase font-bebas tracking-wide group-hover:text-[#d4ff00] transition-colors mb-3">
                  {item.title}
                </h3>
        ...
        <div className="px-6 md:px-16 pb-32 max-w-[1400px] mx-auto">
          <div className="border border-[#d4ff00]/10 bg-white/[0.02] p-12 md:p-16">
            ...
            <div className="mt-10 flex gap-4 flex-wrap">
              {phone ? (
                <a href={`tel:${phone.replace(/\s/g, '')}`} className="bg-[#d4ff00] text-black font-black uppercase tracking-widest px-8 py-4 font-bebas text-xl hover:bg-white transition-colors">
                  Rezervovat trénink
                </a>
              ) : instagram ? (
                <a href={instagram} target="_blank" rel="noopener noreferrer" className="bg-[#d4ff00] text-black font-black uppercase tracking-widest px-8 py-4 font-bebas text-xl hover:bg-white transition-colors">
                  Napsat na Instagram
                </a>
              ) : null}
              <a href="/#pricing" className="border border-white/20 text-white font-black uppercase tracking-widest px-8 py-4 font-bebas text-xl hover:border-[#d4ff00] hover:text-[#d4ff00] transition-all">
                Zobrazit ceník
              </a>
            </div>
          </div>
