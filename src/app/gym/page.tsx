  ...
  return (
    <main className="bg-[#0A0A0A] min-h-screen text-white selection:bg-[#E10600] selection:text-white overflow-x-hidden relative scroll-smooth">
        ...
        <div className="max-w-[1700px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16 items-start">
          ...
          <div className="flex flex-col gap-12 lg:mt-10 text-center">
            <div className="relative bg-black/60 backdrop-blur-2xl p-10 border border-white/10 shadow-2xl">
              ...
              <p className="text-2xl font-black text-white leading-tight mb-8 uppercase italic tracking-tighter">NAŠE FITNESS MÁ ROZLOHU 220 M², 30 STROJŮ VITA A PROFESIONÁLNÍ KARDIO-ZÓNU.</p>
              <p className="text-[11px] text-zinc-500 leading-relaxed italic uppercase tracking-widest">TADY SE NETRÉNUJE PRO FOTKY, TADY SE DŘE PRO VÝSLEDKY.</p>
            </div>
      ...
      <section className="py-24 bg-black relative z-10 border-t border-white/5 overflow-hidden">
         ...
         <div className="flex gap-2 overflow-x-auto pb-10 px-4 no-scrollbar">
            {galleryFiles.map((file, i) => (
              <motion.div key={i} whileHover={{ scale: 1.05 }} className="relative min-w-[300px] aspect-[4/3] overflow-hidden bg-zinc-900 cursor-pointer border border-white/5 group" onClick={() => setSelectedImage(`/images/gym/gallery/${file}`)}>
