...
export default async function GymPage() {
  ...
  return (
    <main className="bg-[#050505] min-h-screen text-white selection:bg-[#E10600] overflow-x-hidden">
      ...
      {/* 1. HERO S OTEVÍRAČKOU (Konečně funkční) */}
          ...
          <div className="max-w-[1400px] mx-auto w-full">
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-end mt-4 gap-6">
               <div className="flex flex-col gap-6">
                 ...
                 {/* OTEVÍRACÍ HODINY - Brutálně čistý */}
                 <div className="flex gap-8 border-l-4 border-[#E10600] pl-5">
                    <div>
      ...
      <section className="relative py-24 px-4">
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-start">
          ...
          {/* UPROSTŘED: PERMANENTKY (Ostrý bílý blok) */}
      ...
      {/* 3. POD TÍM: GALERIE - ZAROVNANÁ NA STŘED */}
      <section className="py-12 px-4 bg-[#050505] border-t border-white/5">
         ...
         {/* Flexbox pro perfektní vycentrování libovolného počtu fotek */}
        <div className="max-w-[1400px] mx-auto flex flex-wrap justify-center gap-4">
          {galleryFiles.map((file, i) => (
            <div key={i} className="relative w-[45%] md:w-[22%] aspect-[4/3] md:aspect-square overflow-hidden group shadow-2xl border border-white/10">
