...
export default function GymPage() {
  ...
  return (
    <main className="min-h-screen selection:bg-[#E10600] selection:text-white overflow-x-hidden scroll-smooth bg-white relative">
      ...
      {/* 3. ŠEDÉ SKLO - TRINITY + POVÍDÁNÍ (smrk) */}
      <section className="relative py-16 px-4 z-10 bg-[#E5E7EB] bg-opacity-20 backdrop-blur-3xl min-h-screen">
        
        {/* POZADÍ NAPEWNO (FIXED) A NÍŽ (smrk) */}
        <div className="fixed inset-0 z-0 pointer-events-none">
          <Image 
            src="/images/hero_revealed.jpg" 
            alt="F77 Background" 
            fill 
            className="object-cover grayscale opacity-10 object-[center_80%]" 
          />
        </div>
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 items-start relative z-10">
          ...
          {/* STŘEDNÍ SLOUP: INFO + PERMICE (smrk) */}
          <div className="flex flex-col gap-8 lg:mt-10">
            
            {/* POVÍDÁNÍ O FITKU - HARDCORE MANIFEST */}
            <div className="relative bg-white/70 backdrop-blur-xl p-6 border border-white/40 shadow-xl border-l-4 border-l-black">
              <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-500 mb-4 italic">Hardcore_Philosophy</h4>
              <p className="text-xs text-zinc-800 font-bold leading-relaxed mb-4">
