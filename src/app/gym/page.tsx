          ...
          <div className="flex flex-col relative z-10 col-span-1 lg:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
               ...
               >
                 ...
                 <div className="relative -mt-28 mx-4 lg:mx-8 bg-black/40 backdrop-blur-xl p-7 border border-white/10 shadow-[0_15px_40px_-10px_rgba(0,0,0,0.9)] z-20 group-hover:border-[#E10600]/50">
                   ...
                   {/* STACK sekce */}
                   <div className="bg-white/10 border border-white/5 p-4 mb-7 space-y-2">
                      <p className="text-[9px] font-black uppercase tracking-widest text-zinc-400 border-b border-white/10 pb-2">Unit_01_Stack</p>
                      <div className="flex items-center gap-3"><span className="h-1.5 w-1.5 bg-[#E10600] rounded-full"></span><p className="text-xs text-zinc-200">Protein Isolát Raw</p></div>
                      <div className="flex items-center gap-3"><span className="h-1.5 w-1.5 bg-[#E10600] rounded-full"></span><p className="text-xs text-zinc-200">Creatine Creapure</p></div>
                      <div className="flex items-center gap-3"><span className="h-1.5 w-1.5 bg-[#E10600] rounded-full"></span><p className="text-xs text-zinc-200">Pre-Workout "Hardcore"</p></div>
                   </div>
               ...
               >
                 {/* ZATMAVENÉ SKLO Box */}
                 <div className="relative mt-10 mx-4 lg:mx-8 bg-black/40 backdrop-blur-xl p-7 border border-white/10 shadow-[0_15px_40px_-10px_rgba(0,0,0,0.9)] z-20 group-hover:border-[#E10600]/50 flex flex-col items-end">
