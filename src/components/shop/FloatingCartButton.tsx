    ...
    <AnimatePresence>
      <Link href="/cart">
        <motion.div
          ...
          className="fixed bottom-8 right-8 z-[9998] flex items-center gap-3 bg-[#d4ff00] text-black px-6 py-4 rounded-full shadow-[0_10px_40px_rgba(212,255,0,0.4)] hover:scale-110 active:scale-95 transition-all group border-2 border-black cursor-pointer"
