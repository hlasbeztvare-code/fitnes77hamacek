      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
          <a href="#" className="flex items-center gap-2 group">
            <div className="w-8 h-8 bg-[#d4ff00] flex items-center justify-center font-black text-black font-black text-xl group-hover:rotate-45 transition-transform duration-500">
              77
            </div>
            <span className="font-black font-black tracking-tighter text-2xl group-hover:tracking-widest transition-all duration-500">FITNESS</span>
          </a>
          ...
          <div className="flex items-center gap-6">
            ...
            <motion.a 
              ...
              whileTap={{ scale: 0.95 }}
              href="#contact" 
              className="hidden md:block px-6 py-2 bg-[#d4ff00] text-black font-black text-lg font-black tracking-widest"
            >
              JOIN NOW
            </motion.a>
          </div>
        ...
        <div className="flex flex-col items-center gap-8">
          {navLinks.map((link, index) => (
            <motion.a
              ...
              href={link.href}
              onClick={() => setIsOpen(false)}
              className="text-black font-black font-black text-6xl md:text-8xl hover:italic transition-all"
            >
              {link.name}
            </motion.a>
          ))}
