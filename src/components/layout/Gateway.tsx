    ...
    <AnimatePresence>
      {show && (
        ...
        >
          ...
          >
            <div className="absolute inset-0 bg-[url('/images/gym/gym15.webp')] bg-cover bg-center opacity-30 grayscale-[0.8] group-hover:grayscale-0 group-hover:scale-105 group-hover:opacity-60 transition-all duration-1000" />
            ...
            <div className="relative h-full flex flex-col items-center justify-center p-8 text-center z-10">
              <motion.h2
                ...
                className="text-7xl md:text-[10vw] font-black uppercase font-black tracking-tighter text-transparent transition-all duration-500 group-hover:text-[#d4ff00]"
          ...
          >
            ...
            <div className="relative h-full flex flex-col items-center justify-center p-8 text-center z-10">
              <motion.h2
                ...
                className="text-7xl md:text-[10vw] font-black uppercase font-black tracking-tighter text-transparent transition-all duration-500 group-hover:text-[#E10600]"
                style={{ WebkitTextStroke: '2px white' }}
              >
                E-SHOP
              </motion.h2>
          ...
          >
            ...
            <h1 className="text-3xl md:text-5xl font-black uppercase font-black tracking-widest text-white mb-6 leading-tight">
