  ...
  return (
    <footer className="border-t border-zinc-200 bg-white py-12 font-black uppercase tracking-tighter">
      <div className="mx-auto grid w-[min(1200px,calc(100%-32px))] gap-8 md:grid-cols-4">
        ...
        <div>
          <h4 className="text-sm font-black uppercase text-zinc-900">Shop</h4>
        ...
        <div>
          <h4 className="text-sm font-black uppercase text-zinc-900">Služby</h4>
          <ul className="mt-4 space-y-2 text-xs text-zinc-500">
        ...
        <div>
          <h4 className="text-sm font-black uppercase text-zinc-900">Kontakt & Obsah</h4>
          <ul className="mt-4 space-y-2 text-xs text-zinc-500">
            <li><a href="tel:+420777105548" className="hover:text-[#E10600] transition-colors font-bold">+420 777 105 548</a></li>
            <li><a href="mailto:fitness77@post.cz" className="hover:text-[#E10600] transition-colors font-bold">fitness77@post.cz</a></li>
            <li className="hover:text-[#E10600] transition-colors cursor-pointer pt-2">Blog & Intel</li>
          </ul>
        </div>
      </div>
