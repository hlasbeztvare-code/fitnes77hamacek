  ...
  await prisma.product.createMany({
    data: [
      ...
      },
      {
        ...
        shoptetPriceId: '67',
        variants: [
          { name: 'Grep', variantCode: 'GRE', stock: 10, shoptetPriceId: '67', price: 890 },
          { name: 'Malina', variantCode: 'MAL', stock: 10, shoptetPriceId: '70', price: 890 },
          { name: 'Borůvka', variantCode: 'BOR', stock: 10, shoptetPriceId: '73', price: 890 }
        ],
